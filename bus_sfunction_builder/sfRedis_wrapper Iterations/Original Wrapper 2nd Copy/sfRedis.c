 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Aug 12 19:28:47 2024
 */
...
extern void sfRedis_Start_wrapper(void **pW,
...
extern void sfRedis_Outputs_wrapper(const real_T *u0,
  ...
  SimStruct *S);
extern void sfRedis_Terminate_wrapper(void **pW,
  const uint16_T *host, const int_T p_width0,
  const int16_T *port, const int_T p_width1,
  const uint16_T *passwd, const int_T p_width2,
  SimStruct *S);
...
static void mdlStart(SimStruct *S)
{
  ...
  sfRedis_Start_wrapper(pW, host, p_width0, port, p_width1, passwd, p_width2, S);
}
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  sfRedis_Outputs_wrapper(u0, y0, pW, host, p_width0, port, p_width1, passwd,
...
static void mdlTerminate(SimStruct *S)
{
  ...
  const int16_T *port = (const int16_T *) mxGetInt16s(PARAM_DEF1(S));
  const uint16_T *passwd = (const uint16_T *) mxGetUint16s(PARAM_DEF2(S));
  sfRedis_Terminate_wrapper(pW, host, p_width0, port, p_width1, passwd, p_width2,
    S);
}
