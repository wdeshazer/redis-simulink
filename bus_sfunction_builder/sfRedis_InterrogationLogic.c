...
* Integer values of 9 or greater represent custom data types
* such as fixed-point types, bus types, and enumerated data types.
* The meaning of each value depends on the number and kind of
* custom data types that you use in a model.
*/
