function sfRedisBusObjectFiles() 
% SFREDISBUSOBJECTFILES initializes a set of bus objects in the MATLAB base workspace 
...
sfRedisBus.PreserveElementDimensions = 0;
