 ...
 *  -------------------------------------------------------------------------
 *
 * Created: Mon Aug 12 22:06:45 2024
 */

#define S_FUNCTION_LEVEL               2
#define S_FUNCTION_NAME                SimpleSfunction
...
extern void SimpleSfunction_Outputs_wrapper(const real_T *u0,
  real_T *y0,
...
static void mdlInitializeSizes(SimStruct *S)
{
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (inUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for input port u0 of S-Function SimpleSfunction");
      return;
    }
  ...
  if (ssGetSimMode(S) != SS_SIMMODE_SIZES_CALL_ONLY) {
    ...
    if (outUnitIdReg != INVALID_UNIT_ID) {
      ...
      ssSetLocalErrorStatus(S,
                            "Invalid Unit provided for output port y0 of S-Function SimpleSfunction");
      return;
    }
...
static void mdlOutputs(SimStruct *S, int_T tid)
{
  ...
  SimpleSfunction_Outputs_wrapper(u0, y0, y_0_width, u_0_width);
}
